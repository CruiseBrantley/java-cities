...
public class CitiesApplication
{
    ...
    public static final String QUEUE_CITY2 = "LowPriorityQueue";
    public static final String  QUEUE_CITY1 = "HighPriorityQueue";
    ...
    {
        return BindingBuilder.bind(appQueueLow()).to(appExchange()).with(QUEUE_CITY2);
    }
    ...
    {
        return BindingBuilder.bind(appQueueHigh()).to(appExchange()).with(QUEUE_CITY1);
    }
